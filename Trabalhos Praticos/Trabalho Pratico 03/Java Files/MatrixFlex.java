    ...
    class Matriz {
        ...
        public void inicializarCelulas() {
            ...
            */
             ...
             * 8º passo: vamos criar uma nova celula abaibo do i(i.inf) e ligar ela com i(i.inf.sup=i)
             * 9º passo: vamos ligar a nova celula(i.inf) com a celula j (i.inf.esq=j) e o j com ele (j.dir=i.in)
             * 10º passo: fazer isso ate o numero maximo de colunas
             * Resultado: ligaremos todos os elementos da matriz, usando a primeira como referencia
             */
        ...
        public void setElementoMatriz(int linha, int coluna, int elemento) {
             ...
             * Resultado: navegamos pela matriz, usando o mesmo tipo de localização de batalha naval
             */
        ...
        public void mostrarDiagonalMatriz() {
            ...
            for (int i = 0; i < this.linha; i++) {
                System.out.println(getElementoMatriz(i, i) + " ");
            }
        }
        ...
        public void mostrarDiagonal2Matriz() {
             ...
             */
            for (int i = 0; i < this.linha; i++) {
                System.out.println(getElementoMatriz(i, (this.coluna - 1 - i)) + " ");
            }
        }
        ...
        public Matriz somaMatrizes(Matriz matriz) {
             ...
             * Resultado: percorremos cada celula das matrizes e somamos o elemento da posição x das duas
             */
        ...
        public Matriz multiplicaMatrizes(Matriz matriz) {
             ...
             * Resultado: percorremos cada celula das matrizes e multiplicamos o elemento da posição x das duas
             */
