    ...
    public Jogador(String pedido) {
        ...
        try {
            ...
            while (scan.hasNextLine()) {
                ...
                if (pedido.equals(elementos[0]) && elementos.length == 8) { // olha o id do pedido feito e completa as informações
...
public class ClasseJava {
    public static void main(String[] args) {
        ...
        while (!pedido.equalsIgnoreCase("FIM")) {
            ...
            Jogador player = new Jogador(pedido); // cria um jogador novo e leva o pedido para o construtor
